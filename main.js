...
var YAMLTableSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Code block language").setDesc("Language identifier for YAML code blocks to be rendered as tables").addText((text) => text.setPlaceholder("yaml-table").setValue(this.plugin.settings.language).onChange(async (value) => {
      if (value.trim()) {
